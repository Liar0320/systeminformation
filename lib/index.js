...
function getDynamicData(srv, iface, callback) {
  ...
  return new Promise((resolve) => {
    process.nextTick(() => {
      ...
      network.ethernetConnected().then((res) => {
        data.ethernetConnected = res;
        functionProcessed();
      });
...
exports.scanInstalledApps = system.scanInstalledApps;
exports.getRegistryInfo = system.getRegistryInfo;

exports.time = osInfo.time;
exports.osInfo = osInfo.osInfo;
exports.systemLanguage = osInfo.systemLanguage;
...
exports.ethernetConnected = network.ethernetConnected;
exports.getIpAddress = network.getIpAddress;
