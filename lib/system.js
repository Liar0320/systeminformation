    ...
    process.nextTick(() => {
      ...
      if (_windows) {
        ...
        const psScript = `
          ...
          $apps | Select-Object -Unique DisplayName, InstallLocation, DisplayVersion, DisplayIcon | ConvertTo-Json
        `;
          ...
          foreach ($regname in $regnames) {
            ...
            foreach ($regPath in $regPaths) {
              if (Test-Path $regPath) {
                ...
                if ($app) {
                  $found = $true
                  $appInfo.path = $app.InstallLocation
                  $appInfo.icon = $app.DisplayIcon
